...
TEST_MODEL = "trainedModels\\trainedModel_epoch19.pt"
...
def plotter(img, label, op, idx, bNum):
    ...
    plt.savefig(os.path.join(OP_DIR, "result_{}_{}.png".format(bNum, idx)))
    fig.clear()
...
if __name__ == "__main__":
    ...
    for batchIdx, batchData in enumerate(testGenerator):
        ...
        img = img.float()
        op = model(img)
        plotter(img, label, op, idx=0, bNum=batchIdx)

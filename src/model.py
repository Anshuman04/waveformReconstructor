...
python trainer.py --dataset other --cfg modifyConfig.yaml --root_path "C:\\Users\\anshu\\JupyterNotebooks\\Seismic-Inpainting\\dataset" --max_epochs 1 --output_dir output --img_size 7200 --base_lr 0.05 --batch_size 4
"""
